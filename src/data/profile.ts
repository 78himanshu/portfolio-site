  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Partnered with Panasonic’s B2B Marketing team to develop an analytics platform integrating GA4 and BigQuery to deliver curated datasets and standardized KPI definitions that powered self-service analytics through Power BI dashboards which helped improve stakeholder decision-making.",
        "Managed Databricks notebooks and Unity Catalog assets to organize analytics workflows and improve discoverability of shared datasets across multiple teams."
      ]
    },
    {
      company: "JAR",
      ...
      bullets: [
        "Developed, validated and deployed an ML-based affluence scoring model using LightGBM and XGBoost to classify new users into spending-affinity tiers, improving customer targeting decisions while replacing a third-party solution that saved ~$15k/month.",
        "Built Airflow-orchestrated ETL pipelines to process high-volume customer transaction events generated by ~20k daily active users streamed through Kafka, transforming raw data stored in AWS S3 into curated MongoDB datasets that powered analytics, KPI reporting, product insights and machine learning models.",
        "Applied NLP techniques to transform terabytes of unstructured financial transaction SMS data into structured datasets for user segmentation, behavioral analysis, spending-trend identification, and predictive modeling, with insights delivered through interactive Tableau dashboards."
      ]
    },
    {
      company: "SHARP",
      ...
      bullets: [
        "Developed a computer vision model using YOLO and PyTorch for real-time object detection, enabling gesture control and facial expression recognition for integration in electronic devices such as TVs, air conditioners, and refrigerators.",
        "Utilized CV2 for live video streaming and real-time image capturing to enable accurate gesture-based interactions, with images labeled using labelImg for training the model.",
        "Achieved robust detection and recognition capabilities for hands-free device operation, enhancing user interaction through gesture controls and facial expressions."
      ]
    },
    {
      company: "SYMPHONY AI",
